...
const TRANSLATIONS = {
  en: {
    ...
    faq7a: 'Your Watchlist updates approximately every 15 minutes. The Diary, Watched, Recommended films, Custom Lists, and Friends Activity catalogs update approximately every 12 hours.',
  ...
  it: {
    ...
    faq7a: 'La tua Watchlist si aggiorna circa ogni 15 minuti. Il Diary, i film Visti (Watched), i Consigliati, le Liste Personalizzate e il catalogo dell\'Attività degli Amici si aggiornano circa ogni 12 ore.',
